    ...
    assets: [
      {
        name: 'Cash Holdings',
        date: '01.01.2025',
        amountCZK: '2.500.000 CZK',
        amountEUR: '102,880.66€',
        notes: 'Liquid assets',
        assetValue: '2.500.000 CZK',
      },
      {
        name: 'Investment Portfolio',
        date: '01.01.2025',
        amountCZK: '3.200.000 CZK',
        amountEUR: '131,687.24€',
        notes: 'Stocks & Bonds',
        assetValue: '3.200.000 CZK',
      },
      {
        name: 'Real Estate',
        date: '01.01.2025',
        amountCZK: '8.500.000 CZK',
        amountEUR: '349,794.24€',
        notes: 'Primary residence',
        assetValue: '8.500.000 CZK',
      },
      {
        name: 'Savings Account',
        date: '01.01.2025',
        amountCZK: '1.800.000 CZK',
        amountEUR: '74,074.07€',
        notes: 'Emergency fund',
        assetValue: '1.800.000 CZK',
      },
      {
        name: 'Investment Land',
        date: '01.01.2025',
        amountCZK: '4.000.000 CZK',
        amountEUR: '164,609.05€',
        notes: 'Development plot',
        assetValue: '4.000.000 CZK',
      },
      {
        name: 'Business Assets',
        date: '01.01.2025',
        amountCZK: '5.000.000 CZK',
        amountEUR: '205,761.32€',
        notes: 'Company shares',
